...
<div id="mySidepanel" class="sidepanel">
    ...
    <a href="adminPage.php" style="font-family: Times, Times New Roman, serif">Dashboard</a>
    <a href="manageInventory.php" style="font-family: Times, Times New Roman, serif">Inventory</a>
    <a href="#" style="font-family: Times, Times New Roman, serif">Orders</a>
