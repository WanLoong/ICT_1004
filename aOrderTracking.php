...
if($result->num_rows > 0)
{
    ...
    $table .= "<table class='table table-bordered'><thead><tr><th>Order ID</th><th>User Purchased</th><th>Product</th><th>Quantity</th><th>Delivered To (ZIP Code)</th><th>Total Price</th><th>Status</th></thead><tbody>";
            ...
            else
            {
                if ($index == 0)
                {
                    $table .= "<tr><td rowspan=" . mysqli_num_rows($result_order) .">" . $row_order['order_id'] . "</td>"
                            ...
                            . "<td>" . $row_order['product_name_purchased'] . "</td>"
                            . "<td>" . $row_order['product_quantity_purchased'] . "</td>"
                            . "<td rowspan=" . mysqli_num_rows($result_order) . ">" . $row_order['zip'] . "</td>"
